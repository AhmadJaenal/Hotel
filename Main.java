...
/**
 * Kelas Food merepresentasikan item makanan yang dapat dipesan di hotel. Kelas
 * ini mengimplementasikan Serializable untuk mendukung serialisasi objek.
 */
class Food implements Serializable {
    ...
    /**
     * Konstruktor untuk kelas Food.
     *
     * @param itemno Nomor item makanan yang dipesan.
     * @param quantity Jumlah makanan yang dipesan.
     */
...
/**
 * Kelas Singleroom merepresentasikan kamar hotel untuk satu orang.
 */
class Singleroom implements Serializable {
    ...
    /**
     * Konstruktor default untuk kelas Singleroom.
     */
    Singleroom() {
        this.name = "";
    }
    ...
    /**
     * Konstruktor untuk kelas Singleroom.
     *
     * @param name Nama tamu.
     * @param contact Nomor kontak tamu.
     * @param gender Jenis kelamin tamu.
     */
...
/**
 * Kelas Doubleroom merepresentasikan kamar hotel untuk dua orang.
 */
class Doubleroom extends Singleroom implements Serializable {
    ...
    /**
     * Konstruktor default untuk kelas Doubleroom.
     */
    Doubleroom() {
        this.name = "";
        this.name2 = "";
    ...
    /**
     * Konstruktor untuk kelas Doubleroom.
     *
     * @param name Nama tamu pertama.
     * @param contact Nomor kontak tamu pertama.
     * @param gender Jenis kelamin tamu pertama.
     * @param name2 Nama tamu kedua.
     * @param contact2 Nomor kontak tamu kedua.
     * @param gender2 Jenis kelamin tamu kedua.
     */
...
/**
 * Kelas NotAvailable digunakan untuk menangani situasi ketika kamar tidak
 * tersedia.
 */
...
/**
 * Kelas holder menyimpan informasi tentang semua jenis kamar yang tersedia di
 * hotel.
 */
...
/**
 * Kelas Hotel merepresentasikan entitas hotel dan menyediakan metode untuk
 * mengelola kamar dan pemesanan.
 */
class Hotel {
     ...
     * Mengambil detail pelanggan untuk pemesanan kamar.
     *
     * @param i Jenis kamar (1-4).
     * @param rn Nomor kamar yang dipesan.
     */
    {
    ...
    /**
     * Memesan kamar berdasarkan jenis yang dipilih.
     *
     * @param i Jenis kamar yang dipilih.
     */
    ...
    /**
     * Menampilkan fitur dari jenis kamar tertentu.
     *
     * @param i Jenis kamar yang dipilih.
     */
     ...
     *
     * @param i Jenis kamar yang ingin dicek.
     */
    ...
    /**
     * Menghitung dan menampilkan tagihan untuk kamar dan makanan yang dipesan.
     *
     * @param rn Nomor kamar.
     * @param rtype Jenis kamar.
     */
    ...
    /**
     * Memesan makanan untuk kamar tertentu.
     *
     * @param rn Nomor kamar.
     * @param rtype Jenis kamar.
     */
...
/**
 * Kelas write digunakan untuk menyimpan data hotel ke dalam file.
 */
class write implements Runnable {
    ...
    /**
     * Konstruktor untuk kelas write.
     *
     * @param hotel_ob Objek holder yang berisi data hotel.
     */
...
/**
 * Kelas utama untuk menjalankan aplikasi hotel.
 */
public class Main {
